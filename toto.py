...
train_images = ["data/freeMono_train.png", "data/freeSans_train.png", "data/freeSerif_train.png", "data/ubuntuCondensed_train.png",
                "data/liberationSerif_train.png", "data/timesNewRoman_train.png", "data/giliusAdf_train.png", "data/latinModernMonoLight_train.png", "data/inconsolata_train.png"]
class_list, feature_list = train(train_images)

parser.add_argument("-m", "--model", default="knn",
                    help="Decide model to be used")
parser.add_argument("image", help="Choose image to be used run OCR on")
parser.add_argument("-s", "--space", default="10",
                    help="Define space thresholds")
parser.add_argument("-a", "--accuracy", action="store_true",
                    help="Turn on accuracy display")
